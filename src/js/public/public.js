// DONT FORGET TO CHECK IF LIGHTBOX ELEMENT ALREADY EXIST IN CASE THERE IS ANOTHER GALLERY BLOCK ALREADY ON THE PAGE
class snoLightbox {
    ...
    createLightbox(){
        const check = document.getElementById('sno_lightbox');
        if(check == null){
...
const box = new snoLightbox('sno-lightbox-nqaknadj3v')
box.init()